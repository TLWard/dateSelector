...
exports.DateSelector = undefined;

var _react = require('react');

var React = _interopRequireWildcard(_react);

var _DateUtilities = require('./DateUtilities');

require('../css/DateSelector.css');
...
var DateSelector = exports.DateSelector = function (_React$Component) {
        ...
        DateSelector.prototype.handleChange = function handleChange(e) {
                ...
                var dteS = (0, _DateUtilities.GetDateString)(dte);
                this.GetDateValue(dteS);
        };

        DateSelector.prototype.AddDay = function AddDay() {

                var dte = (0, _DateUtilities.GetDate)(this.state.input);
                dte.setDate(dte.getDate() + 1);
                this.GetDateValue((0, _DateUtilities.GetDateString)(dte));
                this.setState({ input: (0, _DateUtilities.GetDateString)(dte), time: this.state.time, isModalOpen: false, dte: (0, _DateUtilities.GetDateString)(dte) });
        };
